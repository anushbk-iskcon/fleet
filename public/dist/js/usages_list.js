...
(function($) {
    ...
    var tableBootstrap4Style = {
        ...
        print: function() {
            var pusagetable = $('#pusage').DataTable({
                "processing": true,
                "serverSide": true,
                "ajax": {
                    url: baseurl + "purchase/purchase/partsusagesdata", // json datasource
            ...
            new $.fn.dataTable.Buttons(pusagetable, {
                buttons: [{
                        extend: 'copy',
            ...
            pusagetable.buttons().container().appendTo('#pusage_wrapper .col-md-6:eq(0)');
