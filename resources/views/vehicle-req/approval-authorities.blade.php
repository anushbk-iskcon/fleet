    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('vehicle-req-approval-auth.add')}}" id="addMaintenAuthorityForm" class="row" method="post" accept-charset="utf-8">
                    @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <select class="form-control" required="" name="req_type" id="req_type" disabled>
                                    ...
                                    <option value="{{$reqType['REQUISITION_TYPE_ID']}}" @if($reqType['REQUISITION_TYPE_ID']==1) selected @endif>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body editinfo">
                    <form action="{{route('vehicle-req-approval-auth.update')}}" id="editMaintenAuthorityForm" class="row" method="post" accept-charset="utf-8">
                        @csrf
                        <div class="col-md-12 col-lg-12">
                            <div class="form-group row">
                                <label for="req_type" class="col-sm-3 col-form-label">Requisition Type <i class="text-danger">*</i></label>
