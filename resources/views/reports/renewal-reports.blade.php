...
<small id="controllerName">Renewal Reports</small>
@endsection
                ...
                <table id="empreport" class="table table-striped table-bordered dt-responsive nowrap">
                    ...
                    <tbody>
                        <tr role="row" class="odd">
                            <td class="sorting_1" tabindex="0" style="">1</td>
                            <td>Rashid</td>
                            <td>5551177244338801</td>
                            <td>External</td>
                            <td>Human Resource</td>
                            <td>Helper</td>
                            <td style="display: none;">01923001234</td>
                        </tr>
                        <tr role="row" class="even">
                            ...
                            <td>Human Resource</td>
                            <td>Supervisor</td>
                            <td style="display: none;">01738465735</td>
                        </tr>
                        <tr role="row" class="odd">
                            ...
                            <td>ACCOUNTING</td>
                            <td>Supervisor</td>
                            <td style="display: none;">01738465711</td>
                        </tr>
                        <tr role="row" class="even">
                            ...
                            <td>ACCOUNTING</td>
                            <td>Supervisor</td>
                            <td style="display: none;">01785522541</td>
                        </tr>
                        <tr role="row" class="odd">
                            ...
                            <td>ACCOUNTING</td>
                            <td>Manager</td>
                            <td style="display: none;">12345678</td>
                        </tr>
                        <tr role="row" class="even">
                        ...
                        <tr role="row" class="odd">
                            ...
                            <td>Human Resource</td>
                            <td>Manager</td>
                            <td style="display: none;">645645546</td>
                        </tr>
                        <tr role="row" class="even">
                            ...
                            <td>Technical</td>
                            <td>Manager</td>
                            <td style="display: none;">346567678</td>
                        </tr>
                        <tr role="row" class="odd">
                            ...
                            <td>Human Resource</td>
                            <td>Supervisor</td>
                            <td style="display: none;">3135441815648</td>
                        </tr>
                        <tr role="row" class="even">
                            ...
                            <td>????? ?????</td>
                            <td>Driver</td>
                            <td style="display: none;">0598140354</td>
                        </tr>
                    </tbody>
