    ...
    <div class="col-sm-12">
        <div class="card mb-3">
            <div class="card-header p-2">
                <h4 class="pl-3">Fuel Types<small class="float-right">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="example_ftype" class="table display table-bordered table-striped table-hover ">
                        <thead>
                            <tr>
                                <th>SL</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Diesel</td>
                                <td>
                                    <input name="url" type="hidden" id="url_4" value="https://vmsdemo.bdtask-demo.com/setting/Setting/updateftypefrm" />
                                    ...
                                    <a href="https://vmsdemo.bdtask-demo.com/setting/Setting/delete_fueltype/4" onclick="return confirm('Are you sure ?') " class="btn btn-xs btn-danger btn-sm mr-1"><i class="ti-trash"></i></a>
                                </td>
                            </tr>
                            <tr>
                                <td>2</td>
                                <td>SP95</td>
                                <td>
                                    <input name="url" type="hidden" id="url_5" value="https://vmsdemo.bdtask-demo.com/setting/Setting/updateftypefrm" />
                                    ...
                                    <a href="https://vmsdemo.bdtask-demo.com/setting/Setting/delete_fueltype/5" onclick="return confirm('Are you sure ?') " class="btn btn-xs btn-danger btn-sm mr-1"><i class="ti-trash"></i></a>
                                </td>
                            </tr>
                        </tbody>
