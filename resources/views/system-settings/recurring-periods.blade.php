    ...
    <div class="col-sm-12">
        <div class="card mb-3">
            <div class="card-header p-2">
                <h4 class="pl-3">Manage Recurring Periods<small class="float-right">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="example_recurringperiod" class="table display table-bordered table-striped table-hover ">
                        <thead>
                            <tr>
                                <th>SL</th>
...
<script>
    $(document).ready(function() {
        $("#example_recurringperiod").DataTable();
    });
</script>
@endsection