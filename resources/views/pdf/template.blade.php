            ...
            <div class="row pl-3 pr-5" style="padding-left:10px;padding-right:10px;">
                    ...
                    <table style="width: 100%; border-collapse: collapse;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="border: 1px solid #ddd; padding: 4px;text-align:right;font-size:14px;"><b>{{$amountDebitable}}</b></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <div class="col-md-12 text-center mb-5" style="text-align:center;margin-top:30px;padding-left:20px;padding-right:20px;">
                    <span style="border-bottom: 1px solid black;font-weight: 700;font-size:14px!important;">Transfer
                        Declaration</span>
                    <p style="text-align:left;font-size:15px!important;">We acknowledge the receipt of the above mention
                        materials and hereby request finance to transfer the sum of <b>Rs. <span>{{$amountDebitable}}</span>/-</b></p>
                </div>
            </div>
        </div>
    </div>
