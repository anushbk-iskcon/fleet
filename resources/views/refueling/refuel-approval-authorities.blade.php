    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('refuel-approval-authorities.add')}}" id="addRefuelApprovalAuthorityForm" class="row" method="post" accept-charset="utf-8">
                    @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <select class="form-control" required name="req_type" id="req_type" disabled>
                                    ...
                                    {{-- REQUISITION_TYPE_ID 3 For Refueling --}}
                                    <option value="{{$reqType['REQUISITION_TYPE_ID']}}" @if($reqType['REQUISITION_TYPE_ID']==3) selected @endif>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body editinfo">
                    <form action="{{route('refuel-approval-authorities.update')}}" id="editRefuelApprovalAuthorityForm" class="row" method="post" accept-charset="utf-8">
                        @csrf
                        <div class="col-md-12 col-lg-12">
                            <div class="form-group row">
                                <label for="req_type" class="col-sm-3 col-form-label">Requisition Type <i class="text-danger">*</i></label>
                                <div class="col-sm-5">
                                    ...
                                    {{-- For Sending Requisition Type since select field above is disabled to make it unchangeable --}}
                                    <input type="hidden" name="req_type" value="3"> {{-- 3 for Refueling Requisition --}}
...
<script>
    ...
    let authorityListURL = "{{route('refuel-approval-authorities.list')}}";
